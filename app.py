...
def render_oos_table(df, col='알람등급', days_col=None, days_threshold=15, max_rows=300):
    """알람등급이 OOS이거나 경과일>=threshold인 행을 빨간색으로 강조한 HTML 테이블"""
...
with tab2:
    ...
    render_oos_table(df_rel, days_col='경과일', days_threshold=15)
